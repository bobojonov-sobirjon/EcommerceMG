...
class ManufacturerListSerializer(SlugFromSeoRecordMixin, serializers.ModelSerializer):
    class Meta:
        model = Manufacturer
        fields = ('id', 'name', 'slug', 'logo', 'ordering')


class ManufacturerDetailSerializer(SeoRecordSerializerMixin, serializers.ModelSerializer):
    class Meta:
        model = Manufacturer
        fields = (
            'id',
...
class ProductListSerializer(SlugFromSeoRecordMixin, serializers.ModelSerializer):
...
class ProductDetailSerializer(SeoRecordSerializerMixin, serializers.ModelSerializer):
    manufacturer = ProductManufacturerMiniSerializer(read_only=True)
