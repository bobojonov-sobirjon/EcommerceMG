...
from config.serializer_seo import PageSeoRecordSerializer, SeoRecordSerializer, SlugFromSeoRecordSerializer
...
class AboutCompanySerializer(PageSeoRecordSerializer, serializers.ModelSerializer):
    class Meta:
        model = AboutCompany
        fields = (
            'description',
...
class NewsListSerializer(SlugFromSeoRecordSerializer, serializers.ModelSerializer):
...
class NewsDetailSerializer(SeoRecordSerializer, serializers.ModelSerializer):
